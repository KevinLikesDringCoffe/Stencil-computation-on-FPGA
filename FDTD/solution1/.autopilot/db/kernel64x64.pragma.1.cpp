...
_ssdm_SpecArrayPartition( bondary_e_buffer, 1, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( bondary_w_buffer, 1, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( bondary_n_buffer, 1, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( bondary_s_buffer, 1, "CYCLIC", 2, "");

_ssdm_SpecArrayPartition( array_buffer, 2, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( array_buffer, 1, "CYCLIC", 2, "");

 data_t array_buffer_tmp[64][64];
_ssdm_SpecArrayPartition( array_buffer_tmp, 2, "CYCLIC", 2, "");
_ssdm_SpecArrayPartition( array_buffer_tmp, 1, "CYCLIC", 2, "");
